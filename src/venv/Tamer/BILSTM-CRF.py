...
with torch.no_grad():
    ...
    print('tag：'+ str(precheck_tags.tolist()))
    print('prediction ：'+ str(model(precheck_sent)))
 
print('=============begin BiLSTM+CRF training=============')
...
for epoch in range(200):  # again, normally you would NOT do 300 epochs, it is toy data
    for sentence, tags in training_data:
        ...
        optimizer.step()
    if epoch%50 == 0:
        print(f'model training epoch{epoch}的Loss value：{loss[0]}')
# 
